...
2. Set `NEXT_PUBLIC_SITE_URL=https://importverifier.netlify.app`.
...
9. Complete one Stripe test checkout, verify the paid quota, open the customer portal, cancel, and verify webhook idempotency.
