...
const unlimitedCopy: Record<Language, { title: string; body: string; features: string[]; cta: string; fairUse: string }> = {
  es: { title: 'Unlimited', body: 'Una sola suscripción. Analiza todo tu catálogo, usa ImportVerifier AI y genera informes sin contar productos.', features: ['Análisis de productos ilimitados*', 'ImportVerifier AI', 'PDF y Excel con tu historial', 'Regulatory Twin + Impact Radar', 'Conectores Shopify, Amazon y Etsy'], cta: 'Elegir Unlimited', fairUse: '*Uso ilimitado sujeto a medidas técnicas razonables contra abuso automatizado.' },
  en: { title: 'Unlimited', body: 'One subscription. Analyse your whole catalogue, use ImportVerifier AI and generate reports without counting products.', features: ['Unlimited product analysis*', 'ImportVerifier AI', 'PDF and Excel with history', 'Regulatory Twin + Impact Radar', 'Shopify, Amazon and Etsy connectors'], cta: 'Choose Unlimited', fairUse: '*Unlimited use subject to reasonable technical safeguards against automated abuse.' },
  fr: { title: 'Unlimited', body: 'Un seul abonnement. Analysez tout votre catalogue, utilisez ImportVerifier AI et générez des rapports sans compter les produits.', features: ['Analyses de produits illimitées*', 'ImportVerifier AI', 'PDF et Excel avec historique', 'Regulatory Twin + Impact Radar', 'Connecteurs Shopify, Amazon et Etsy'], cta: 'Choisir Unlimited', fairUse: '*Utilisation illimitée soumise à des protections techniques raisonnables contre les abus automatisés.' },
  de: { title: 'Unlimited', body: 'Ein Abo. Analysiere deinen gesamten Katalog, nutze ImportVerifier AI und erstelle Berichte ohne Produktzählung.', features: ['Unbegrenzte Produktanalysen*', 'ImportVerifier AI', 'PDF und Excel mit Verlauf', 'Regulatory Twin + Impact Radar', 'Shopify-, Amazon- und Etsy-Konnektoren'], cta: 'Unlimited wählen', fairUse: '*Unbegrenzte Nutzung unter angemessenen technischen Schutzmaßnahmen gegen automatisierten Missbrauch.' },
  it: { title: 'Unlimited', body: 'Un solo abbonamento. Analizza l’intero catalogo, usa ImportVerifier AI e genera report senza contare i prodotti.', features: ['Analisi prodotti illimitata*', 'ImportVerifier AI', 'PDF ed Excel con storico', 'Regulatory Twin + Impact Radar', 'Connettori Shopify, Amazon ed Etsy'], cta: 'Scegli Unlimited', fairUse: '*Uso illimitato soggetto a ragionevoli protezioni tecniche contro gli abusi automatizzati.' },
...
export default function Home() {
  ...
  const structuredData = {
    ...
    offers: [
      { '@type': 'Offer', name: t.pricing.freeTitle, price: '0', priceCurrency: 'EUR', description: `${FREE_TRIAL_PRODUCT_LIMIT} free product analyses` },
